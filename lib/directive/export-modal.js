...
app.directive('exportModal', function ($rootScope, $routeParams) {
    return {
        ...
        link        : function (scope) {
            ...
            scope.optional = ($rootScope.selectedWorld ? ($rootScope.selectedWorld.share_strategy === 'optional' || $rootScope.selectedWorld.share_strategy === 'last_only' ) : '');
            ...
            function share() {
                ...
                code = '#trigger:' + scope.display.trigger.id + '\n' + code;
