    ...
    return {
        ...
        link        : function (scope, element, attrs, workspaceCtl) {
            ...
            scope.update = td.throttle(THROTTLE_MS, false, function () {
                ...
                //init the lightboard code
                language.initLightBoard().then(function (response) {
            ...
            */
            ...
            /**
             * Send message to chrome App to render the lightboard
             * @return void
             */
            scope.makeItReal = function () {
                var language = require('../language/index');
                language.sendToBoard(scope.source);
            };
