...
app.directive('display', function ($window, $timeout, $location, $rootScope) {
    ...
    return {
        ...
        link        : function (scope, element, attrs, workspaceCtl) {
             ...
             * @return void
             */
            scope.update = td.throttle(THROTTLE_MS, false, function (oldValue, newValue, h, ui, arg) {
                ...
                timer = setTimeout(function () {
                    ...
                    if (!ui) {
                        ...
                        if (scope.trigger.valueName && arg) {
                            settings.pre = 'var ' + scope.trigger.valueName + '=\'' + arg + '\';\n'
                        }
                    }
