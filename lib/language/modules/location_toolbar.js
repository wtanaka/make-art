...
function createToolbar(callback) {
    ...
    toolbarContainer.innerHTML = '<form>' +
                                    '<p style="color: white; margin: 10px; display: inline-block;font-size:1.2em">Location</p>' +
                                    '<input type="text" style="margin: 10px; display: inline-block;flex:1">' +
                                    '<button style="z-index: 1; margin: 10px; display: inline-block;" type="submit">Set Location</button>' +
                                '</form>';
    ...
    toolbarContainer.querySelector('form').onsubmit = function (e) {
        e.preventDefault();
