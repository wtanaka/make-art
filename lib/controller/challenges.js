...
app.controller('ChallengesController', function ($scope, $rootScope, $routeParams, $location, $http, contentService, $sce) {
    ...
    $scope.selectChallenge = function (challenge) {
        ...
        cloned = _.cloneDeep(challenge);
        cloned.video = $sce.trustAsResourceUrl(cloned.video);
        $scope.selectedChallenge = cloned;
